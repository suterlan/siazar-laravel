          ...
          <ul class="navbar-nav flex-fill w-100 mb-2">
            <li class="nav-item dropdown">
              ...
              <ul class="list-unstyled pl-4 w-100 collapse {{ Request::is('dashboard/surat*') ? 'show' : '' }}" id="surat" style="">
                <li class="nav-item dropdown">
                    <a href="#suratkeluar" class="dropdown-toggle nav-link pl-3 {{ Request::is('dashboard/surat*') ? 'link-active collapsed' : '' }}" data-toggle="collapse" aria-expanded="false"><span class="ml-1">Surat Keluar</span></a>
                    <ul class="list-unstyled pl-4 w-100 collapse {{ Request::is('dashboard/surat*') ? 'show' : '' }}" id="suratkeluar" style="">
                        <a href="/dashboard/surat" class="nav-link pl-3 {{ Request::is('dashboard/surat') ? 'link-active' : '' }}"><span class="ml-1">Semua Surat</span></a>
                        <a href="/dashboard/surat/penerimaan" class="nav-link pl-3 {{ Request::is('dashboard/surat/penerimaan*') ? 'link-active' : '' }}"><span class="ml-1"> Penerimaan Siswa</span></a>
                        <a href="/dashboard/surat/panggilan" class="nav-link pl-3 {{ Request::is('dashboard/surat/panggilan*') ? 'link-active' : '' }}"><span class="ml-1"> Pemanggilan Siswa</span></a>
                        <a href="/dashboard/surat/mutasi" class="nav-link pl-3 {{ Request::is('dashboard/surat/mutasi*') ? 'link-active' : '' }}"><span class="ml-1"> Mutasi Siswa</span></a>
                    </ul>
                </li>
