                ...
                <div class="col-md-12">
                    <div class="card shadow">
                        <div class="card-header">
                            <strong class="card-title">Surat Umum</strong>
                                <a href="/dashboard/suratkeluar/umum/create" class="btn btn-primary btn-sm float-right" type="button"><span class="fe fe-file-plus"></span> Surat Baru </a>
                            <p class="card-text">Tabel Surat Umum</p>
                        </div>
                        <div class="card-body">
                            ...
                            @endif
                            <table id="tbSuratUmum" class="table table-stripped table-hover table-surat-keluar">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <a href="/dashboard/suratkeluar/umum/cetak/{{ $surat->id }}" id="cetak" class="btn btn-sm btn-primary mr-1">
                                                    <span class="fe fe-printer fe-16"></span>
                                                </a>
                                                <a href="/dashboard/suratkeluar/umum/download/{{ $surat->id }}" id="download" class="btn btn-sm btn-secondary">
