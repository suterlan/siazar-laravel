                    ...
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table id="tbSuratMutasi" class="table table-stripped table-hover table-surat-keluar">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    <a href="/dashboard/suratkeluar/mutasi/cetak/{{ $surat->id }}" id="cetak" class="btn btn-sm btn-primary mr-1" target="_blank">
                                                        <span class="fe fe-printer fe-16"></span>
                                                    </a>
                                                    <a href="/dashboard/suratkeluar/mutasi/download/{{ $surat->id }}" id="download" class="btn btn-sm btn-secondary" target="_blank">
