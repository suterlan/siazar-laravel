                ...
                <div class="card shadow">
                    <div class="card-header">
                        <strong class="card-title">Surat Mutasi Siswa</strong>
                            <a href="/dashboard/surat/mutasi/create" class="btn btn-primary btn-sm float-right" type="button"><span class="fe fe-file-plus"></span> Surat Baru </a>
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <table id="tbSuratMutasi" class="table table-stripped table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <a href="/dashboard/surat/mutasi/cetak/{{ $surat->id }}" id="cetak" class="btn btn-sm btn-primary mr-1">
                                                <span class="fe fe-printer fe-16"></span>
                                            </a>
                                            <a href="/dashboard/surat/mutasi/download/{{ $surat->id }}" id="download" class="btn btn-sm btn-secondary">
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <a class="btn btn-outline-info btn-sm" href="/dashboard/surat/mutasi/{{ $surat->id }}"><span class="fe fe-eye"></span> Detail</a>
                                            <a class="btn btn-outline-warning btn-sm ml-1" href="/dashboard/surat/mutasi/{{ $surat->id }}/edit"><span class="fe fe-edit"></span> Edit</a>
                                            <form action="/dashboard/surat/mutasi/{{ $surat->id }}" method="post">
                                                @method('delete')
                                                @csrf
