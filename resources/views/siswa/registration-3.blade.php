    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-12 col-lg-10">
                ...
                {{-- Step 3 --}}
                <form action="/dashboard/siswa/registrasi-step3" method="POST">
                @csrf
                <div id="step3" class="my-2 pt-4">
                    ...
                    <div class="float-right">
                        <a href="/dashboard/siswa/registrasi-step2" class="btn btn-danger" type="button"><span class="fe fe-arrow-left"></span> Back</a>
