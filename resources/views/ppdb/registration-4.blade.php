            ...
            <div class="col-12 col-lg-10">
                ...
                <div id="step4" class="my-2 pt-4">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="nama_siswa" value="{{$registrasi->nama_siswa ?? ''}}" disabled>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <label for="nik">NIK</label>
                            <input type="text" id="nik" class="form-control" value="{{$registrasi->nik ?? ''}}" disabled>
                        </div>
                        <div class="form-group col-md-6">
                    ...
                    <div class="float-right">
                        <a href="/dashboard/ppdb/registrasi-step3" class="btn btn-danger" type="button"><span class="fe fe-arrow-left"></span> Back</a>
                        <a href="/dashboard/ppdb/registrasi-finish" class="btn btn-success" type="button"><span class="fe fe-save mr-1"></span>Save</a>
                    </div>
                </div>
            </div>
        </div>
